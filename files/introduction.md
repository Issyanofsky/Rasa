# Topics:
  ...
  * what we can do with Rasa
  * An (externaly) brif history of NLP
...
* Dialogue systems - they do (achive the task) by talking with an automated system in two-way conversation.
